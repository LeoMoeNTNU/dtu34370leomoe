...
ap_and_val_t value_with_procs(info_t info, int* array){
...
int value(info_t info, int* array){
    ap_and_val_t ap_and_val = value_with_procs(info,array);
    int val = ap_and_val.val;
    killallprocs(ap_and_val.ap);
